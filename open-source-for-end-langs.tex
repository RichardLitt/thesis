...
% TODO Subsection on mapping software as a case study
% There don't appear to be any open source language mapping guidelines or databases. The closest is http://www.worldgeodatasets.com/index.html.
% Update - there's an LDC paper on it, gawne2016mapmaking. TODO Go through this paper and highlight open source tools. Also hu2018web, which cites gawne and mentions a lot of open source tools, like Leaflet. Maybe add a subsection on mapping here?
% Another note: "Packages in the software R (R Core Team 2016) such as ggplot2 (Wikham 2009), dplyr (Wikham et al. 2016), and igraph (Csárdi & Nepusz 2006) were used in order to compile isoglosses and patterns identified in the Interac- tive Dialectal Maps in cumulative geographical maps, dot plots, and network graphs." {cenerini2017mapping} This paper cites these, but doens't open source their own stuff - still, useful for talking about tooling that is used by open source which isn't LRL specific.
