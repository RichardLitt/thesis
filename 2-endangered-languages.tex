...
In this section, I will define these terms: endangered, minority, low-resource, under-resourced, threatened, incident, surprise, moribund, dormant, extinct, historic, revitalised, computer (such as JavaScript), and constructed languages. This will help inform why I've chosen to focus on \emph{low resource} languages (LRLs), and specifically low resource natural languages with living populations.
...
% - Extinct languages
% - Historic languages (Old Swedish, https://spraakbanken.gu.se/swe/forskning/diabase)
% - Moribund languages
% - Sleeping languages
